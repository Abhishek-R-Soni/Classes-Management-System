...
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'ShowEvent')" id="defaultOpen">Show Event</button>
  <button class="tablinks" onclick="openCity(event, 'Download')">Download</button>
  <button class="tablinks" onclick="openCity(event, 'ShowStudent')"></button>
</div>

<div id="ShowEvent" class="tabcontent">
